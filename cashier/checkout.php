...
$query = "INSERT INTO sales(id_sales, id_customer, id_user, order_date, total)
        VALUES ('$id_sales', '$id_customer', '$id_user', '$order_date', '$total')";
...
if (isset($_SESSION['keranjang'])) {
    foreach ($_SESSION['keranjang'] as $id_product => $jumlah) {
        ...
        while ($data = mysqli_fetch_array($result)){
            $query2 = "INSERT INTO detail_sales(id_detail_sales, id_sales, id_product, quantity, sub_total)
                    VALUES ('$id_detail_sales', '{$data['id_sales']}', '$id_product', '$jumlah', '$sub_total')";
